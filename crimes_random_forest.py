...
random_forest_machine = RandomForestClassifier(n_estimators=12)
random_forest_machine.fit(X_train, Y_train)
y_pred = random_forest_machine.predict(X_test)
print('random12')
print(y_pred)
...
random_forest_machine = RandomForestClassifier(n_estimators=13)
random_forest_machine.fit(X_train, Y_train)
y_pred = random_forest_machine.predict(X_test)
print('random13')
print(y_pred)
...
random_forest_machine = RandomForestClassifier(n_estimators=14)
random_forest_machine.fit(X_train, Y_train)
y_pred = random_forest_machine.predict(X_test)
print('random14')
print(y_pred)
